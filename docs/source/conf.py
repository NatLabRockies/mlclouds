...
author = 'Grant Buster, Brandon Benton'

pkg = os.path.dirname(os.path.abspath(os.path.dirname(__file__)))
pkg = os.path.dirname(pkg)
sys.path.append(pkg)

from mlclouds import __version__ as v
...
latex_documents = [
    (master_doc, 'mlclouds.tex', 'mlclouds Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'mlclouds', 'mlclouds Documentation',
     [author], 1)
]
